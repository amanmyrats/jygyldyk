...
import webapps.catalogue.reviews.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'Requires moderation'), (1, 'Approved'), (2, 'Rejected')], default=webapps.catalogue.reviews.utils.get_default_review_status, verbose_name='Status')),
