...
import custommodels.fields.autoslugfield
import custommodels.fields.slugfield
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', custommodels.fields.slugfield.SlugField(max_length=255, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', custommodels.fields.autoslugfield.AutoSlugField(blank=True, editable=False, max_length=128, populate_from='name', unique=True, verbose_name='Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upc', custommodels.fields.NullCharField(help_text='Universal Product Code (UPC) is an identifier for a product which is not specific to a particular  supplier. Eg an ISBN for a book.', max_length=64, unique=True, verbose_name='UPC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original', models.ImageField(max_length=255, upload_to=utils.models.get_image_upload_path, verbose_name='Original')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, verbose_name='Name')),
                ('slug', custommodels.fields.autoslugfield.AutoSlugField(blank=True, editable=False, max_length=128, populate_from='name', unique=True, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_file', models.FileField(blank=True, max_length=255, null=True, upload_to=utils.models.get_image_upload_path)),
                ('value_image', models.ImageField(blank=True, max_length=255, null=True, upload_to=utils.models.get_image_upload_path)),
