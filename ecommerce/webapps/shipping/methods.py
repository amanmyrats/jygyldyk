...
class OfferDiscount(Base):
    ...
    def code(self):
        """
        Returns the :py:attr:`code <webapps.shipping.methods.Base.code>` of the wrapped shipping method.
        """
    ...
    def name(self):
        """
        Returns the :py:attr:`name <webapps.shipping.methods.Base.name>` of the wrapped shipping method.
        """
    ...
    def discount_name(self):
        """
        Returns the :py:attr:`name <webapps.offer.abstract_models.BaseOfferMixin.name>` of the applied Offer.
        """
