...
from webapps.customer.utils import get_password_reset_url
...
from views.generic import PostActionMixin
...
class EmailHistoryView(PageTitleMixin, generic.ListView):
    ...
    template_name = 'communication/email/email_list.html'
    ...
    def get_queryset(self):
        """
        Return Queryset of :py:class:`Email <webapps.customer.abstract_models.AbstractEmail>`
...
class EmailDetailView(PageTitleMixin, generic.DetailView):
    """Customer email"""
    template_name = "communication/email/email_detail.html"
...
class OrderHistoryView(PageTitleMixin, generic.ListView):
    ...
    def get_queryset(self):
        """
        Return Queryset of :py:class:`Order <webapps.order.abstract_models.AbstractOrder>`
