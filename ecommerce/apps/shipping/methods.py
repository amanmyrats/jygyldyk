...
class OfferDiscount(Base):
    ...
    def code(self):
        """
        Returns the :py:attr:`code <apps.shipping.methods.Base.code>` of the wrapped shipping method.
        """
    ...
    def name(self):
        """
        Returns the :py:attr:`name <apps.shipping.methods.Base.name>` of the wrapped shipping method.
        """
    ...
    def discount_name(self):
        """
        Returns the :py:attr:`name <apps.offer.abstract_models.BaseOfferMixin.name>` of the applied Offer.
        """
