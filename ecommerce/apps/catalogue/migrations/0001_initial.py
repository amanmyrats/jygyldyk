...
import models_custom.fields
import models_custom.fields.autoslugfield
import models_custom.fields.slugfield
import utils.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models_custom.fields.slugfield.SlugField(max_length=255, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models_custom.fields.autoslugfield.AutoSlugField(blank=True, editable=False, max_length=128, populate_from='name', unique=True, verbose_name='Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upc', models_custom.fields.NullCharField(help_text='Universal Product Code (UPC) is an identifier for a product which is not specific to a particular  supplier. Eg an ISBN for a book.', max_length=64, unique=True, verbose_name='UPC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, verbose_name='Name')),
                ('slug', models_custom.fields.autoslugfield.AutoSlugField(blank=True, editable=False, max_length=128, populate_from='name', unique=True, verbose_name='Slug')),
