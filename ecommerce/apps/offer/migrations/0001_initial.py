    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models_custom.fields.PositiveDecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Value')),
                ...
                ('proxy_class', models_custom.fields.NullCharField(default=None, max_length=255, verbose_name='Custom class')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proxy_class', models_custom.fields.NullCharField(default=None, max_length=255, unique=True, verbose_name='Custom class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redirect_url', models_custom.fields.ExtendedURLField(blank=True, verbose_name='URL redirect (optional)')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
