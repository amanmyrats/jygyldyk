...
class OfferListView(ListView):
    ...
    def get_queryset(self):
        """
        Return a queryset of active :py:class:`ConditionalOffer <apps.offer.abstract_models.AbstractConditionalOffer>`
        instances with an :py:attr:`offer_type <apps.offer.abstract_models.AbstractConditionalOffer.offer_type>`
        of :py:const:`ConditionalOffer.SITE <apps.offer.abstract_models.AbstractConditionalOffer.SITE>`.
        """  # noqa
...
class OfferDetailView(ListView):
    ...
    def get_queryset(self):
        """
        Return a queryset of all :py:class:`Product <apps.catalogue.abstract_models.AbstractProduct>`
        instances related to the :py:class:`ConditionalOffer <apps.offer.abstract_models.AbstractConditionalOffer>`.
        """  # noqa
...
class RangeDetailView(ListView):
    ...
    def get_queryset(self):
        """
        Return a queryset of all :py:class:`Product <apps.catalogue.abstract_models.AbstractProduct>`
        instances related to the :py:class:`Range <apps.offer.abstract_models.AbstractRange>`.
        """  # noqa
