...
from webapps.customer.signals import user_registered
...
from api.serializers.login import LoginSerializer, UserSerializer, RegisterUserSerializer
from webapps.customer.mixins import RegisterUserMixin
