...
from webapps.basket import signals
from core.loading import get_model, get_class
...
from api.basket import operations
from api.utils.loading import get_api_classes, get_api_class
from api.views.utils import BasketPermissionMixin

from webapps.basket.models import (
    Basket, Line
)
from webapps.shipping.repository import Repository
from webapps.order.models import ShippingAddress
from api.serializers.basket import (
    BasketSerializer, VoucherAddSerializer, VoucherSerializer, BasketLineSerializer
)
...
from api.serializers.checkout import ShippingAddressSerializer, ShippingMethodSerializer
...
class AddProductView(APIView):
    ...
    POST(url, quantity)
    {
        "url": "http://testserver.org/api/products/209/",
        "quantity": 6
    }
    ...
    basket, you should pass the optional ``options`` property:
    {
        ...
        "quantity": 6,
        "options": [{
            "option": "http://testserver.org/api/options/1/",
            "value": "some value"
        }]
    }
    """
...
class LineList(BasketPermissionMixin, generics.ListCreateAPIView):
    ...
    Add a line to the basket, example::
        ...
        {
            "basket": "http://127.0.0.1:8000/api/baskets/100/",
            "line_reference": "234_345",
            "product": "http://127.0.0.1:8000/api/products/209/",
            "stockrecord":
                "http://127.0.0.1:8000/oapi/products/209/stockercords/1/",
            "quantity": 3,
            "price_currency": "EUR",
