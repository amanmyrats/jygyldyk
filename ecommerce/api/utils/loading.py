...
from core.loading import _pluck_classes, _import_module


def oscarapi_class_loader(module_label, classnames, module_prefix="api"):
...
def get_api_classes(module_label, classnames):
    return oscarapi_class_loader(module_label, classnames, "api")
