...
from api.basket.operations import assign_basket_strategy
...
from webapps.checkout.mixins import OrderPlacementMixin
from webapps.checkout.calculators import OrderTotalCalculator
from webapps.order.models import (
    ShippingAddress, BillingAddress, Order, Line, LineAttribute, Surcharge
)
...
from webapps.address.models import UserAddress

from api.serializers.basket import VoucherSerializer, OfferDiscountSerializer
...
class PriceSerializer(serializers.Serializer):
    currency = serializers.CharField(
        max_length=12, default=django_settings.DEFAULT_CURRENCY, required=False
    )
