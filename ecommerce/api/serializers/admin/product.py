...
from api.serializers.utils import OscarHyperlinkedModelSerializer
from api.utils.categories import create_from_full_slug
from api.utils.loading import get_api_classes, get_api_class
from api.utils.models import fake_autocreated

from webapps.catalogue.models import Product, ProductClass, ProductAttributeValue, Option
from api.serializers.admin.partner import AdminStockRecordSerializer
from api.serializers.product import (
    BaseProductSerializer, BaseCategorySerializer, ProductImageSerializer, 
    ProductAttributeSerializer, OptionSerializer
)
