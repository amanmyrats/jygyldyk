...
from .views.login import LoginView, UserDetail, RegistrationView
from .views.basket import BasketView, AddProductView, AddVoucherView, ShippingMethodView, LineList, BasketLineDetail
from .views.admin.partner import StockRecordDetail, PartnerList, PartnerDetail
from .views.basic import BasketList, BasketDetail, LineAttributeDetail, OptionList, OptionDetail, CountryList, CountryDetail, RangeList, RangeDetail
...
from .views.product import ProductList, ProductDetail, ProductStockRecords, ProductStockRecordDetail, ProductPrice, ProductAvailability, CategoryList, CategoryDetail
# (
#     ProductList,
#     ProductDetail,
#     ProductStockRecords,
...
from .views.checkout import CheckoutView, OrderList, OrderDetail, OrderLineList, OrderLineDetail, OrderLineAttributeDetail, UserAddressList, UserAddressDetail
...
from .views.admin.product import (
    ProductAdminList, ProductAdminDetail, ProductClassAdminList, ProductClassAdminDetail, 
    ProductAttributeAdminList, ProductAttributeAdminDetail, AttributeOptionGroupAdminList, 
    AttributeOptionGroupAdminDetail, CategoryAdminList, CategoryAdminDetail
)
...
from .views.admin.order import OrderAdminList, OrderAdminDetail, OrderLineAdminList, OrderLineAdminDetail, OrderLineAttributeAdminDetail
...
from .views.admin.user import UserAdminList, UserAdminDetail
