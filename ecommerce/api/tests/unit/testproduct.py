...
from api.serializers.fields import CategoryField
...
from api.serializers.admin.product import AdminProductSerializer
from api.serializers.product import AttributeOptionGroupSerializer

from webapps.catalogue.models import (
    Product, ProductClass, ProductAttributeValue, Category, Option, AttributeOptionGroup
)
...
class ProductTest(APITest):
    ...
    @mock.patch("api.views.product.ProductList.get_serializer_class")
...
class ProductAttributeValueSerializerTest(_ProductSerializerTest):
    ...
    @mock.patch("api.utils.download.urlopen")
...
class TestProductAdmin(APITest):
    ...
    def test_entity_error(self):
        ...
        msg = (
            ...
            "'api.serializers.hooks.entity_internal_value' to provide an "
            "implementation"
        )
